    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryIngredients", x => new { x.IngredientId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_CategoryIngredients_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryIngredients_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryIngredients_CategoryId",
